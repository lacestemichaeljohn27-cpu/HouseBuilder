...
--
-- Table structure for table `house_models`
--
...
CREATE TABLE `house_models` (
  ...
  `style` enum('Modern','Traditional','Mediterranean','Minimalist') COLLATE utf8mb4_general_ci NOT NULL,
  `bedrooms` int NOT NULL,
  `bathrooms` int NOT NULL,
  `floors` int NOT NULL,
  `lot_size` enum('Packed','Common','Standard','High-End') COLLATE utf8mb4_general_ci NOT NULL,
  `base_price` decimal(12,2) NOT NULL,
  `model_file` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
--
-- Dumping data for table `house_models`
--
