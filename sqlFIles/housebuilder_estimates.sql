...
CREATE TABLE `estimates` (
  ...
  CONSTRAINT `estimates_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`),
  CONSTRAINT `estimates_ibfk_2` FOREIGN KEY (`house_id`) REFERENCES `house_models` (`house_id`)
